...
export default function Test() {
  ...
  const renderForm = () => (
    <div className="test-form-card">
      ...
      <label>
        Syllabus
        <input value={sallabus} onChange={(e) => setsallabus(e.target.value)} placeholder="e.g. A-Level, SAT" />
      </label>
      <label>
        Chapter
        <input value={chatpter} onChange={(e) => setchapter(e.target.value)} placeholder="Chapter name or number" />
      </label>
      <label>
        Topic
      ...
      <label>
        Subtopic
        <input value={suntopic} onChange={(e) => setsubtopic(e.target.value)} placeholder="Subtopic e.g. Derivatives" />
      </label>
